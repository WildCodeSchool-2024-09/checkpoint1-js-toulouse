...
function findSeniors(persons) {
  const devWebSenior = persons.filter(person => person.experience >= 5 && person.job === 'web dev')
  const dataAnalystSenior = persons.filter(person => person.experience >= 5 && person.job === 'data analyst')
